---
title: "Bad News: The Wilted Rose & Sepsinia's Tower"
date: "2025-09-25"
type: session
description: "The party discovers Wilted Rose issue #6 leaflets. Dame Parthena Crabbe bursts in — Sepsinia's depression is worsening. DC asks the party to help, revealing Sepsinia's history: sleepwalking, nightmares, her fiance Opilio's suicide. Arturo and Rhenquist explore a magically odd tower. The party learns Sepsinia used to admit to nightmares but stopped confiding."
session_number: 39
tags: [investigation, relationship, npc-introduction]
locations:
  - "[[crabb residence]]"
---
...
## _Tea with Zarissa and Sepsinia_

### Tea time with Zarissa and Sepsinia
...
- _makes occultism check_ 24 - Z understands quickly that S is under the effects of a powerful memory modification effect.

---

## _Investigating the House_
...
## _Caritas Speaks with the Maid_
...
- [[Allister Hound]] - bartender - 6ft 6 tall blond hair neatly cut, ripped body, looks like he can bench press an anvil, very nice bright teeth
  ...
  - offers to mix a "Zespire" if he likes... Allister asks if there's anything else. _womp womp_ he asks for whiskey.
